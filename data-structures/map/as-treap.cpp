...
class map {
  private:
    ...
    node<K,V>* _leftrotate(node<K,V>*);
    node<K,V>* _rightrotate(node<K,V>*);
...
template <class K, class V>
node<K,V>* map<K,V>::_leftrotate(node<K,V> *oldroot) {
  node<K,V>
    *newroot = oldroot->r,
    *t2 = newroot->l;
...
template <class K, class V>
node<K,V>* map<K,V>::_rightrotate(node<K,V> *oldroot) {
  node<K,V>
    *newroot = oldroot->l,
    *t2 = newroot->r;
